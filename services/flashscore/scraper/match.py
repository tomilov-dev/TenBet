...
from models import Match, MatchDescription, TimeScore
...
class MatchParser:
    ...
    def get_description(
        ...
        if response:
            ...
            tournament = s.find("meta", {"name": "og:description"}).get("content")
...
class MatchScraper(FlashScoreScraper):
    def __init__(
        self,
        proxy: str = None,
        debug: bool = False,
    ...
    async def scrape(self, code: str) -> Match:
