...
from model.service import RankSDM, TennisPlayerDataSDM
from manager.service import (
    SportType,
    SPORT,
    TennisExplorerPlayerScraperInterface,
    TennisExplorerRankDatesScraperInterface,
    TennisExplorerRankScraperInterface,
)

TE_MAX_RATE = settings.TENNISEXPLORER_MAX_RATE
TE_RATE_PERIOD = settings.TENNISEXPLORER_RATE_PERIOD
...
class TennisExplorerRankDatesScraper(
    TennisExplorerRankDatesScraperInterface,
    TennisExplorerSraper,
):
    def __init__(
        self,
        sport: SportType,
        ...
        TennisExplorerRankDatesScraperInterface.__init__(self, sport)
        TennisExplorerSraper.__init__(self, proxy, max_rate, rate_period, debug)
...
class TennisExplorerRankScraper(
    TennisExplorerRankScraperInterface,
    TennisExplorerSraper,
):
    def __init__(
        ...
        TennisExplorerRankScraperInterface.__init__(self, sport)
        TennisExplorerSraper.__init__(self, proxy, max_rate, rate_period, debug)
    ...
    def parse_page(self, response: str) -> list[RankSDM]:
        s = soup(response, "lxml")
        ...
        for index in range(len(rows)):
            ...
            rank = RankSDM(date=date, rank=rank, points=points, name=name, te_id=te_id)
            ranks.append(rank)

        return ranks

    async def scrape_page(self, url: str) -> list[RankSDM]:
...
class TennisExplorerPlayerScraper(
    TennisExplorerPlayerScraperInterface,
    TennisExplorerSraper,
):
    def __init__(
        ...
        TennisExplorerPlayerScraperInterface.__init__(self, sport)
        TennisExplorerSraper.__init__(self, proxy, max_rate, rate_period, debug)

    def parse(self, response: str, te_id: str) -> TennisPlayerDataSDM:
        s = soup(response, "lxml")
